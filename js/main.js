...
function showResults(count) {
    ...
    if(currentIndex === count) {
        ...
        if(rightAnswer < count && rightAnswer > count / 2) {
            theResult = `<span class="good">Good </span> Your  Degree : ${rightAnswer * 10} of ${count * 10}`;
        }
        else if(rightAnswer === count) {
            theResult = `<span class="ex">Excellent </span> Your  Degree: ${rightAnswer * 10} of ${count * 10}`;
        }
        else {
            theResult = `<span class="bad">Bad </span> Your  Degree : ${rightAnswer * 10} of ${count * 10}`;
        }
